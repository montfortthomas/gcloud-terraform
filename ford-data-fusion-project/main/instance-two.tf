...
resource "google_compute_instance" "t2" {
    ...
    description          = "Created for Dataflow job: 2021-09-10_00_24_47-14808084775878198701"
    enable_display       = false
    guest_accelerator    = []
    id                   = "projects/ford-data-fusion-project/zones/asia-south1-b/instances/mv-teltonikaio-data-09100024-j81g-harness-5rwb"
    instance_id          = "3977280216280512136"
    label_fingerprint    = "BdJ9zbUQjio="
    labels               = {
        "dataflow_job_id"                         = "2021-09-10_00_24_47-14808084775878198701"
        "dataflow_job_name"                       = "mv_teltonikaio_data"
    ...
    metadata             = {
        ...
        "created-by"                = "projects/398013698563/zones/asia-south1-b/instanceGroupManagers/dataflow-mv-teltonikaio-data-09100024-j81g-harness"
        ...
        "instance-template"         = "projects/398013698563/global/instanceTemplates/dataflow-mv-teltonikaio-data-09100024-j81g-harness"
        "instance_group_name"       = "dataflow-mv-teltonikaio-data-09100024-j81g-harness"
        "job_id"                    = "2021-09-10_00_24_47-14808084775878198701"
        "job_name"                  = "mv_teltonikaio_data"
        ...
        "sdk_pipeline_options"      = jsonencode(
            {
                ...
                options      = {
                    ...
                    dataflowEndpoint                    = ""
                    dataflowJobId                       = "2021-09-10_00_24_47-14808084775878198701"
                    dataflowKmsKey                      = null
                    ...
                    googleApiTrace                      = null
                    inputTopic                          = "projects/ford-data-fusion-project/topics/tp_fmc001_io"
                    ...
                    outputTableSpec                     = "ford-data-fusion-project:teltonika.io_events"
        ...
        "worker_pool"               = "mv-teltonikaio-data-09100024-j81g-harness"
    }
    metadata_fingerprint = "drNBXSkjlWg="
    name                 = "mv-teltonikaio-data-09100024-j81g-harness-5rwb"
    project              = "ford-data-fusion-project"
    resource_policies    = []
    self_link            = "https://www.googleapis.com/compute/v1/projects/ford-data-fusion-project/zones/asia-south1-b/instances/mv-teltonikaio-data-09100024-j81g-harness-5rwb"
    tags                 = [
        "dataflow",
    ]
    ...
    attached_disk {
        device_name = "mv-teltonikaio-data-09100024-j81g-harness-disk-0"
        mode        = "READ_WRITE"
        source      = "https://www.googleapis.com/compute/v1/projects/ford-data-fusion-project/zones/asia-south1-b/disks/mv-teltonikaio-data-09100024-j81g-harness-disk-0"
    }
    ...
    boot_disk {
        ...
        mode        = "READ_WRITE"
        source      = "https://www.googleapis.com/compute/v1/projects/ford-data-fusion-project/zones/asia-south1-b/disks/mv-teltonikaio-data-09100024-j81g-harness-5rwb"
